...
outputName = "results/Imbal_c$(nc)_inter$(interEffect)_common$(common)_xd$(xdiff)_v$(variance)_dim$(dims)_prec$(prec)alph$(alph)bet$(bet)"

# END user input
#
# imbalanced groups
fractions = repeat([1 / (nc + 1) ], nc)
